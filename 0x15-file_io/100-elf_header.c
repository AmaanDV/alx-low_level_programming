...
/**
 * print_magic - Prints all the magic numbers of an ELF header.
 * @e_ident: The  pointer to an array containing the ELF magic numbers.
 *
 ...
 * @e_idention: The pointer to an array containing the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
...
/**
 * print_osabi - Prints all the OS/ABI of an ELF header.
 * @e_ident: The  pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 * @e_ident:The  pointers to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @e_entry: The addresess of the ELF entry point.
 * @e_ident: The  pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
 * main - This main function would  Displays the information contained in the
